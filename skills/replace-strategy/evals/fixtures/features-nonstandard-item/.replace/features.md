...
|---|---|---|---|---|---|---|---|---|---|
| order | 注文管理 | 2 | /orders, /orders/:id | GET /api/orders, GET /api/orders/:id | user | orders, order_items | CSV 出力（対象） | #52 | open |
...
|---|---|---|---|---|---|
| user | ユーザー | GET /api/users, GET /api/users/:id | order, report | #48 | closed |
