...
|--------|------------|---------------|-------|
| Pass Rate | 63% ± 34% | 42% ± 17% | +0.20 |
| Time | 53.1s ± 25.4s | 47.2s ± 14.4s | +5.9s |
| Tokens | 1742 ± 552 | 1449 ± 313 | +293 |
...
- **今回の追加分（eval 5 / 6）**: eval-5 は with_skill 100%（5/5 × 3 run）に対しベースライン 40%、eval-6 は with_skill 62% に対しベースライン 43%。
